    ...
    exports.PmltqEditor = function(ace, element, theme, mode, schema) {
        ...
        Object.keys(functions).forEach(function(type) {
            ...
            for (var i = a.length; i--;) {
                ...
                PMLTQMode.$completer.addCompletion(a[i], type);
            }
        });

        {
            ...
            for (var i = def_keywords.length; i--;) {
                ...
                PMLTQMode.$completer.addCompletion(def_keywords[i], type);
            }
        }
        ...
        Object.keys(schema.attributes).forEach(function(type) {
            ...
            for (var i = a.length; i--;) {
                ...
                PMLTQMode.$completer.addCompletion(a[i], "ATTRIBUTE."+type);
            }
        });
        ...
        while (r = relations.shift()) {
            ...
            Object.keys(data).forEach(function(t2) {
                ...
                if (Array.isArray(a)) {
                    ...
                    for (var i = a.length; i--;) {
                        PMLTQMode.$highlightRules.addAtributes(t2, a[i]);
                        PMLTQMode.$completer.addCompletion(a[i], t2);
                    }
                } else {
                    relations.push([a, t2]);
                }
