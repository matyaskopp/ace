...
var PmltqHighlightRules = function() {
    ...
    var test = [{ /*ref*/
            ...
            { /*simple_test->predicate*/
                ...
                regex: "(\\s*)("+TYPE_PREFIX+")\\b(\\s*)("+regexATTR_simple+")",
                _push: "simple_test",
                _next: "step",
                next: _push_next
            },
...
*/
        ...
        "conditions" : [
            ...
            { /*member_selector*/  // it must be before TYPE
                token: ["OPERATOR.NOT","SP","MEMBER.D3","SP.D2","OPERATOR"] , 
                regex: "(!?)(\\s*)(member)(\\s*)((?:\\:\\:)?)",
                _push: "member", 
                _next: "simple_attribute",
                next: _push_next
...
*/
            { /*nested_selector*/
                token: ["storage.type.optional","SP","storage.type.plus","SP","RELATION","SP","TYPE","SP","VAR","SP","OPERATOR.ASSIGN","SP", "lPAR"], /* (?)? (relation)? (type)? var := [*/
                regex: "(\\??)(\\s*)(\\+?)(\\s*)("+regexRelation+"?)(\\s*)("+regexType+"?)(\\s*)("+regexSelector_name+")(\\s*)(:=)(\\s*)(\\[)",
                _push: "conditions",
                _next: "conditions",
                next: _push_next
            },
            { /*nested_selector*/
                token: ["storage.type.optional","SP","storage.type.plus","SP","RELATION","SP","TYPE","SP", "lPAR"], /* (?)? (relation)? (type)? [*/
                regex: "(\\??)(\\s*)(\\+?)(\\s*)("+regexRelation+"?)(\\s*)("+regexType+"?)(\\s*)(\\[)",
                _push: "conditions",
                _next: "conditions",
                next: _push_next
            },
        ...
        "or_and_clause" : [
            ...
            {
                token: ["OPERATOR","OPERATOR.NOT","SP"],
                regex: "(or|and)(\\s*)(!?)",
                next: "simple_test"
            },
            { /* to parse spaces at begining of rule is necessary*/
        ...
        "comma_clause" : [
            ...
            {
                token: ["OPERATOR.COMMA","OPERATOR.NOT","SP"],
                regex: "(,)(\\s*)(!?)",
                next: "simple_test"
            },
            {
        ...
        "term" : [
            ...
            { // every + simple_attribute
                token: ["OPERATOR.EVERY","SP","type_prefix","SP","ATTRIBUTE"],
                regex: "(\\*?)(\\s*)((?:"+TYPE_PREFIX+"\\b)?)(\\s*)("+regexATTR_simple+")",
                next: "step"
            },            
            { /*FUNC*/             // !!!
...
*/  
        ...
        "member" : [
            ...
            {
                token: ["VAR","SP","OPERATOR.ASSIGN","SP", "rPAR"],
        ...
        "simple_attribute" : [
            ...
            { /*SIMPLE ATTRIBUTE*/
                token: ["type_prefix","SP","ATTRIBUTE"],
                regex: "((?:"+TYPE_PREFIX+"\\b)?)(\\s*)("+regexATTR_simple+")",
                next: "step"
            },
            { /*SIMPLE ATTRIBUTE*/
                token: ["ATTRIBUTE"],
