...
var PmltqHighlightRules = function() {
   ...
   var r_functions = '(?:\\b(?:descendants|lbrothers|rbrothers|sons|depth_first_order|order_span_min|order_span_max|depth|lower|upper|length|substr|tr|replace|substitute|match|ceil|floor|round|trunc|percnt|name|type_of|id|file|tree_no|address|abs|exp|power|log|sqrt|ln)\\b)';
   var r_agreg_functions = '(?:\\b(?:min|max|sum|avg|count|ratio|concat|row_number|rank|dense_rank)\\b)';
