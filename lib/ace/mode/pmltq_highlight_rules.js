...
var regexRelationName = "(?:[_a-zA-Z][-.\\/_a-zA-Z]*(?=\\s*->|\\s*"+regexSelector_name+"(?!\\s*:=)|\s+"+Name+"\\s*(?:\\[|\\$)))";
var regexRelationName_param = "(?:[_a-zA-Z][-.\\/_a-zA-Z]*(?=(?:\\{[0-9]*,[0-9]*\\})(?:\\s*->|\s*"+regexSelector_name+"(?!\\s*:=)|\\s+"+Name+"}\\s*(?:\\[|\\$))))";
...
if(pmlrf_relations && regexRelationPmlrfRelations !== "") regexRelation += "|(?:"+regexRelationPmlrfRelations+"(?:\\{\\s*[0-9]*,[0-9]*\\})?)(?!\\:\\:)(?:->)?)";
if(regexRelationName !== "") regexRelation += "|(?:"+regexRelationName+"(?!\\:\\:)(?:->)?)";
if(regexRelationName_param !== "") regexRelation += "|(?:"+regexRelationName_param+"\\{\\s*[0-9]*,[0-9]*\\})(?!\\:\\:)(?:->)?)";
...
*/
            { /*nested_selector*/
                token: ["OPERATOR.NOT","SP","OCCURRENCES","SP","storage.type.optional","SP","storage.type.plus","SP","RELATION","SP","TYPE","SP","VAR","SP","OPERATOR.ASSIGN","SP", "lPAR"], /* (?)? (relation)? (type)? var := [*/
            ...
            { /*nested_selector*/
                token: ["OPERATOR.NOT","SP","OCCURRENCES","SP","storage.type.optional","SP","storage.type.plus","SP","RELATION","SP","TYPE","SP", "lPAR"], /* (?)? (relation)? (type)? [*/
                regex: "(!?)(\\s*)((?:"+r_OCCURR+")?)(\\s*)(\\??)(\\s*)(\\+?)(\\s*)("+regexRelation+"?)(\\s*)("+regexType+"?)(\\s*)(\\[)",
                _push: "conditions",
                _next: "conditions",
                next: _push_next
            },
...
//                next: "test"
        ...
        "term" : [
            ...
            { // hack it is imposible to recognize TYPEPREFIX and ATTRIBUTE
