...
var PmltqHighlightRules = function() {
   ...
   this.$rules = {
        ...
        "TEST" : [
            {
              token:["SP","RELATION.TEST.OK.regexRelationTree"],
              regex: "(\\s*)("+regexRelationTree+"\\s(?!->)(?:\\:\\:)?)",
              next:"start"
            },
            {
              token:["SP","RELATION.TEST.OK.regexRelationOrdering"],
              regex: "(\\s*)("+regexRelationOrdering+"\\s(?!->)(?:\\:\\:)?)",
              next:"start"
            },
            {
              token:["SP","RELATION.TEST.OK.regexRelationName"],
              regex: "(\\s*)((?:"+regexRelationName+"\\s*(?!\\:\\:)(?:->)?))",
              next:"start"
            },
            {
              token:["SP","RELATION.TEST.OK.regexRelationName_param"],
