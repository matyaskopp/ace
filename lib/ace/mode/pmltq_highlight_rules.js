...
*/
            { /*nested_selector*/
                token: ["OPERATOR.NOT","SP","storage.type.optional","SP","storage.type.plus","SP","RELATION","SP","TYPE","SP","VAR","SP","OPERATOR.ASSIGN","SP", "lPAR"], /* (?)? (relation)? (type)? var := [*/
            ...
            { /*nested_selector*/
                token: ["OPERATOR.NOT","SP","storage.type.optional","SP","storage.type.plus","SP","RELATION","SP","TYPE","SP", "lPAR"], /* (?)? (relation)? (type)? [*/
...
//                next: "test"
            ...
            {
                token: ["OPERATOR.COMMA"], // jump to conditions
                regex: "(,)",
                next: _pop // top???
            },
            { /* to parse spaces at begining of rule is necessary*/
